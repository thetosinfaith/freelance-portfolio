    ...
    <header>
      <div className="navbar-container">
        <div className="navbar-links">
          ...
          <div className="navbar-link" onClick={() => navigate("/speaking")}>
            Speaking
          </div>
        </div>
        ...
        <div>
          <ul className="navbar-menu">
            ...
            <li className="navbar-menu-item" onClick={() => navigate("/blog")}>
              Consultation
            </li>
            <li>
            ...
            <div className="navbar-mobile-menu">
              <div className="navbar-mobile-menu-wrapper">
                <nav>
                  ...
                  <a href="#" onClick={() => navigate("/speaking")}>
                    About
                  </a>
                  <a href="#" onClick={() => navigate("/portfolio")}>
                    Projects
                  </a>
